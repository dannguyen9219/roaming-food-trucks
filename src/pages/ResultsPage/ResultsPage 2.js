...
/* 
The results page only makes one call to the backend. It defaults to 5 miles once you enter the zip code. All the other filters are filters on the frontend. So that is returning a larger set of food trucks. In the controllers, it is taking the food truck route
*/
